...
def process_raw_data():
    ...
    end = pd.Timestamp('2024-03-01', tz='Europe/Amsterdam')  
    country_code = 'NL'
    ...
    price_data = pd.read_csv('data/raw/raw_prices_2023_2024.csv', index_col=0, parse_dates=True)
    ...
    historical.to_csv('data/processed/merged_dataset_2023_2024_cleaned.csv')
