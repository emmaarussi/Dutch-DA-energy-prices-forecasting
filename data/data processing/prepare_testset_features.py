...
def main():
    ...
    df = pd.read_csv(os.path.join(base_dir, 'processed', 'callibration_dataset_2024_cleaned.csv'), index_col=0)
    ...
    print("\nSaving features...")
    df_features.to_csv(os.path.join(base_dir, 'processed', 'multivariate_features_testset.csv'))

    print(f"\nFeature preparation complete. Shape: {df_features.shape}")
    print("Features available:")
    print(df_features.columns.tolist())

    cols = pd.read_csv(os.path.join(base_dir, 'processed', 'multivariate_features_testset.csv'), nrows=1).columns
