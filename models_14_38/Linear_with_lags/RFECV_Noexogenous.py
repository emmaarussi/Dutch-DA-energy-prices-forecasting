...
✅ Completed full rolling evaluation in 43679.70 seconds
...
def main():
    ...
    horizons = [14, 24, 38]
    out_dir = Path("models_14_38/Linear_with_lags/RFECV_Noexogenous/plots/optimizedretrain")
    out_dir.mkdir(parents=True, exist_ok=True)
    ...
    while current_test_start + test_window <= rolling_end:
        ...
        for horizon in horizons:
            ...
            all_residuals.append(results['predictions']['residual'])
